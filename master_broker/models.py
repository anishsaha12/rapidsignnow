...
class MasterBroker(models.Model):
...
class MasterBrokerLawFirmLink(models.Model):
    master_broker = models.ForeignKey(MasterBroker)
    law_firm = models.ForeignKey(LawFirm)
    law_firm_rates = models.ForeignKey(LawFirmRates)


class MasterBrokerInvestigatorLink(models.Model):
    master_broker = models.ForeignKey(MasterBroker)
