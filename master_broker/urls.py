...
from master_broker import views
...
urlpatterns = [
    ...
    url(r'^pending-receivables', views.pending_receivables),
    url(r'^collected-payments', views.collected_payments),
    url(r'^cases-to-be-approved', views.cases_to_be_approved),
    url(r'^refund-for-case/', views.refund_case),
