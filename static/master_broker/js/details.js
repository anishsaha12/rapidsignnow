...
$('#updateStatusBtn').click(function () {
    ...
    change_status_call = function (extra_info) {
        ...
        $.post('/master-broker/change-status/', {
    ...
    if (selected_status === 'Client cancelled') {
        ...
        swal({
            ...
            <input style="display: block;" id="client-cancelled-more-info" class="swal2-input" placeholder="More info (optional)" type="text">',
                ...
                preConfirm: function () {
                    return new Promise(function (resolve, reject) {
                        ...
                        resolve({
                            ...
                            'Mileage Description': no_of_miles,
                            'More Info': '',
                            'RSN extra expenses':Number.parseFloat(rsn_extra_expenses) > 0.0 ? rsn_extra_expenses : '0',
                            'RSN extra expenses info': ''
                        });
                    });
                }
